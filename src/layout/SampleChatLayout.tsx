...
import { SampleMessageList, type SampleMessageListRef } from '../components/messages/sample/MessageList';
...
export interface SampleChatLayoutProps {
  theme?: Theme;
...
export interface SampleChatLayoutRef {
...
export const SampleChatLayout = forwardRef<SampleChatLayoutRef, SampleChatLayoutProps>(
  (
    {
      theme = 'dark',
      showAgentInfo = false,
    ...
    const messageListRef = useRef<SampleMessageListRef>(null);
    ...
    return (
      ...
      >
        <SampleMessageList
          ...
          activityMaxEntries={activityMaxEntries}
...
SampleChatLayout.displayName = 'SampleChatLayout';
